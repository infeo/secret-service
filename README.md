...
A _Java_ library to store secrets in the _Gnome Keyring_ over _DBus_.

The library is conform to the freedesktop.org
[Secret Service API 0.2](https://specifications.freedesktop.org/secret-service/0.2) specification and thus compatible with Gnome linux systems.
