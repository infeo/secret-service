...
public class TransportEncryption implements AutoCloseable {
    ...
    private org.freedesktop.secret.Service service; // TODO: should adhere to the interface
    ...
    public TransportEncryption(org.freedesktop.secret.Service service) {
    ...
    public class OpenedSession {
        public Optional<EncryptedSession> generateSessionKey() {
            ...
            try {
                ...
                log.error("Cloud not generate a new session key for the current session", e);
                return Optional.empty();
            }
        }
